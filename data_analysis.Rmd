...
data <- read.csv("./clean data/cleaned_unstrat.csv")
...
calculate_jacobian <- function(predictors, coefficients) {
  ...
  jacobian <- deriv * predictors_with_intercept 
  return(jacobian)  # Returns individual-level Jacobians
}
...
write.csv(coef_pvalue_wide_named, 
          "./model coefficients/coef_and_pvalues_unstrat.csv", 
          row.names = FALSE)
...
write.csv(coef_df_named, 
          "./model coefficients/coef_only_unstrat.csv", 
          row.names = FALSE)
```
...
write.csv(risk_scores_df, 
          "./individual stats/probability_unstrat.csv", 
          row.names = FALSE)
write.csv(variance_df, 
          "./individual stats/probability_variance_unstrat.csv", 
          row.names = FALSE)
...
write.csv(network_df, "./pair stats/all_pairs_variances_unstrat.csv")
...
write.csv(significant_pairs, 
          "./pair stats/significant_pairs_unstrat.csv", 
          row.names = FALSE)
write_xlsx(formatted_significant_pairs, 
           "./Cytoscape inputs/formatted_pairs_unstrat.xlsx")
```
...
write.csv(reference_table, 
          "./reference tables/reference_unstrat.csv", 
          row.names = FALSE)
...
write.csv(comprehensive_table, 
          "./pair stats/comprehensive_pairs_unstrat.csv", 
          row.names = FALSE)
```
