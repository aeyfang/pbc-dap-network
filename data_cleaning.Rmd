...
dog_owner <- dog_owner %>%
  dplyr::select(dog_id, dd_age_years, dd_weight_lbs, dd_breed_pure, dd_breed_pure_or_mixed, dd_sex, dd_spayed_or_neutered, od_annual_income_range_usd,mp_flea_and_tick_treatment,mp_heartworm_preventative) %>%
  mutate(
