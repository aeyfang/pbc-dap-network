...
# Consolidate osteoarthritis and degenerative joint disease
health_condition_wide <- health_condition_wide %>%
  mutate(
...
generate_frequency_table <- function(data, suffix = "") {
  ...
  disease_frequencies$Disease.Name[disease_frequencies$Code.from.DAP.data == "1211"] <- "Laryngeal paralysis"
