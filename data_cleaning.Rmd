...
health_condition_wide <- health_condition %>%
  ...
  mutate(
    condition_1207 = if_else(condition_1207 == 1 | condition_1108 == 1, 1, 0),
    condition_1108 = NULL # Consolidate IVDD columns
  ) %>%
  mutate(
    condition_1804 = if_else(rowSums(select(., condition_1804:condition_1808)) > 0, 1, 0),
    condition_1805 = NULL,
    condition_1806 = NULL,
    condition_1807 = NULL,
    condition_1808 = NULL # Consolidate fracture entries
  ) %>%
