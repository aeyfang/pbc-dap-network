...
significant_pairs_ya <- read.csv("./results/networks/significant_pairs_young_adult.csv")
disease_frequencies_ya <- read.csv("./data/frequencies/disease_frequencies_young_adult.csv")

significant_pairs_ma <- read.csv("./results/networks/significant_pairs_mature_adult.csv")
disease_frequencies_ma <- read.csv("./data/frequencies/disease_frequencies_mature_adult.csv")

significant_pairs_s <- read.csv("./results/networks/significant_pairs_senior.csv")
disease_frequencies_s <- read.csv("./data/frequencies/disease_frequencies_senior.csv")

# Load directed network significant pairs (12-month window)
significant_pairs_directed <- read.csv("./results/networks/significant_pairs_directed_12m.csv") %>%
  rename(from = source, to = target)

# Load previously created figure
p_heatmap <- readRDS("./results/networks/network_overlap_heatmap.rds")
```
...
ggsave(
  filename = "./outputs/figures/undirected_network_graph.png",
  plot = p,
  dpi = 600,
  width = 10,
  height = 9,
...
# Save main network plot
ggsave(
  filename = "./outputs/figures/ear_infection_subgraph.png",
  plot = p_sub,
  dpi = 600,
  width = 10,
  height = 9,
...
ggsave(
  filename = "./outputs/figures/final_network_layout.png",
  plot = final_layout,
  dpi = 600,
  width = 12,
  height = 15,
...
ggsave(
  filename = "./outputs/figures/final_network_layout.tiff",
  plot = final_layout,
  dpi = 600,
  width = 12,
  height = 15,
...
ggsave(
  filename = "./outputs/figures/young_adult_network_graph.png",
  plot = p_ya,
  dpi = 600,
  width = 10,
  height = 8,
...
ggsave(
  filename = "./outputs/figures/mature_adult_network_graph_collapsed.png",
  plot = p_ma,
  dpi = 600,
  width = 10,
  height = 8,
...
ggsave(
  filename = "./outputs/figures/senior_network_graph_collapsed.png",
  plot = p_senior,
  dpi = 600,
  width = 10,
  height = 8,
...
ggsave(
  filename = "./outputs/figures/combined_2x2_with_heatmap_cowplot_legend.png",
  plot = final_plot,
  dpi = 600,
  width = 20,
  height = 18,
...
ggsave(
  filename = "./outputs/figures/combined_2x2_with_heatmap_cowplot_legend.tiff",
  plot = final_plot,
  dpi = 600,
  width = 20,
  height = 18,
...
g_directed <- graph_from_data_frame(significant_pairs_directed, directed = TRUE)
...
ggsave(
  filename = "./outputs/figures/directed_12m.png",
  plot = p_directed,
  dpi = 600,
  width = 10,
  height = 8,
...
ggsave("./outputs/figures/combined_directed.tiff", combined_directed_plot, dpi = 600, width = 12, height = 14, units = "in", compression = "lzw")
ggsave("./outputs/figures/combined_directed.png", combined_directed_plot, dpi = 600, width = 12, height = 14, units = "in")
...
write.csv(visualization_summary, "./results/statistics/comprehensive_visualization_summary.csv", row.names = FALSE)
