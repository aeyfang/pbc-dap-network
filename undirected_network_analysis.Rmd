...
dir.create("./network tables", showWarnings = FALSE, recursive = TRUE)
...
# Convert disease variable names to numerical codes
...
# Save both raw statistics and formatted input
write.csv(significant_pairs, 
          paste0("./pair stats/significant_pairs_", analysis_type, ".csv"), 
          row.names = FALSE)
write.csv(formatted_significant_pairs,
           paste0("./network tables/formatted_pairs_", analysis_type, ".csv"))
```
