...
write.csv(overall_stats, "./additional stats/overall_coefficient_stats.csv", row.names = FALSE)
write.csv(per_covariate_stats, "./additional stats/per_covariate_stats.csv", row.names = FALSE)
write.csv(coefficient_stats, "./additional stats/detailed_coefficient_stats.csv", row.names = FALSE)
