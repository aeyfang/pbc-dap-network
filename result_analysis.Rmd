...
model_coef <- read.csv(file = "./model coefficients/coef_and_pvalues_unstrat.csv")
...
write_xlsx(save_sig, "./additional stats/coef_visualization.xlsx")
write.csv(save_sig, "./additional stats/coef_visualization.csv", row.names = FALSE)
```
...
ggsave(
  filename = "./figures/full_coef_table.tiff", 
  plot = coef_plot, 
...
ggsave(
  filename = "./figures/full_coef_table.png", 
  plot = coef_plot, 
  width = 10, height = 22, units = "in", 
  dpi = 600
)
...
saveRDS(overlap_heatmap, "./network tables/network_overlap_heatmap.rds")
```
