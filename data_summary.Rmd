...
```
```{r}
boxplot <- readRDS("./medical_history_boxplot.rds")

# Add margin below the boxplot (top plot)
# Boxplot with formatting and label
...
ggsave("./summary statistics/combined_Fig1_plots.tiff", 
       combined_plot,
       width = 18,      
       height = 14,    
       dpi = 600, 
...
ggsave(
  filename = "./summary statistics/combined_Fig1_plots.png",
  plot = combined_plot,
  width = 18,
  height = 14,
  dpi = 600
